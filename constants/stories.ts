...
export const stories: Story[] = [
  {
    ...
    country: "Ghana",
    moral: "Wisdom is not for one person to keep; it should be shared.",
    content: [
      "Once, Anansi the Spider had all the wisdom in the world stored in a big pot. He decided to hide it on top of a tall tree so no one else could have it.",
  ...
  },
  {
    ...
    country: "Kenya",
    moral: "Even the smallest friends can be the greatest allies.",
    content: [
      "A mighty lion was sleeping in the savanna when a tiny mouse accidentally ran across his nose. The lion woke up angrily and was about to eat the mouse.",
  ...
  },
  {
    ...
    country: "Nigeria",
    moral: "Honesty and humility are more valuable than cleverness.",
    content: [
      "There was a great feast in the sky, and the birds were all invited. The hungry tortoise, who couldn't fly, convinced the birds to give him feathers.",
  ...
  },
  {
    ...
    country: "Senegal",
    moral: "Communication and listening are keys to understanding.",
    content: [
      "In a small village, there was a drummer named Kofi who could make his drum 'talk'. He could send messages across hills and rivers.",
  ...
  },
  {
    ...
    content: [
      "A greedy hyena was walking and found two paths. One smelled of a small goat, the other of a big cow. He wanted both!",
  ...
  },
  {
    ...
    country: "Namibia",
    moral: "Courage and fighting for what is right will leave a beautiful mark.",
    content: [
      "Long ago, zebras were all white. They lived in a land that was hot and dry, except for one waterhole, which was guarded by a grumpy baboon.",
  ...
  {
    id: 7,
    title: "The Clever Rabbit and the Crocodile",
    country: "Egypt",
    moral: "A sharp mind is more powerful than sharp teeth.",
    content: [
      "A clever rabbit wanted to cross the wide Nile river to eat sweet sugarcane on the other side. But the river was full of crocodiles.",
  ...
  },
  {
    ...
    country: "Madagascar",
    moral: "Respect nature, and it will provide for you.",
    content: [
      "In a thirsty village, there stood a giant baobab tree. The elders said it was magical and held water inside, but it must be respected.",
  ...
  {
    id: 9,
    title: "The Woman Who Became a Waterfall",
    country: "Zimbabwe",
    moral: "Love and sacrifice can create beauty that lasts forever.",
    content: [
      "A beautiful woman named Nyami lived in a village by a great river. She loved her people dearly. One year, the rains did not come, and the river began to dry up.",
  ...
  {
    id: 10,
    title: "The Shongololo and the Millipede",
    country: "South Africa",
    moral: "Kindness and sharing bring the sweetest rewards.",
    content: [
      "A kind Shongololo (a large millipede) loved to bake sweet berry cakes. He always shared his cakes with all the other insects.",
